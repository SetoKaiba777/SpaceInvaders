...
/**
 * Entidade que representa o app principal do jogo
 * 
...
public class MainApp extends Application {
    ...
    private Parent createContent() {
        ...
        ImageView imageView = new ImageView(new Image(getClass().getResource("/images/title.jpg").toExternalForm()));
        ...
        MenuItem startButton = new MenuItem("COMEÇAR", 250);
