...
/**
 * Entidade que representa a "caixa" do menu inicial do jogo.
 * 
...
public class MenuBox extends Pane {
    ...
    /**
	 * Cria uma nova entidade do tipo MenuBox
	 * 
	 * @param width largura do menu
	 * @param height altura do menu
	 */
	 ...
	 * Adiciona novos itens na caixa
	 * 
         * @param item itens a serem adicionados
	 */
